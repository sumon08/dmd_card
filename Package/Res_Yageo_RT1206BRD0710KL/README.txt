...
Part RT1206BRD0710KL (component id 41cb5dcc9d06fa12) experienced an error during datasheet export:
Traceback (most recent call last):
  File "build/bdist.linux-x86_64/egg/upconvert/writer/altium/altium.py", line 421, in export_component
    datasheets[datasheet_url] = self.save_datasheet(datasheet_url)
  File "build/bdist.linux-x86_64/egg/upconvert/writer/altium/altium.py", line 329, in save_datasheet
    r.raise_for_status()
